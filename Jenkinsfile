		...
		stage('Static Code Analysis') {    
			steps{       
				echo '------------>Analisis de codigo estatico<------------'  
                 ...
                 sh "${tool name: 'SonarScanner', type: 'hudson.plugins.sonar.SonarRunnerInstallation'}/bin/sonar-scanner-Dproject.settings=sonar-project.properties -Dsonar.organization=DanielGiraldo-GitHub  -Dsonar.host.url=https://sonarcloud.io -Dsonar.login=6294439d51de179b274690e548b084ac32b14a0d"
           }
          }
}
stage('Build') {
